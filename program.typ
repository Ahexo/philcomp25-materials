...
#resumes("Participantes (Speakers)", [Conoce a los ponentes y participantes varios de esta edición:\ Meet the speakers and various participants of this edition:#footnote("Esta lista está en orden alfababético y no es exhaustiva: Dependiendo la disponibilidad de sus datos, puede que algunos ponentes no estén incluidos en ella.\nThis list is in alphabetical order and is not exhaustive: Depending on the availability of their data, some speakers may not be included.")], "database/resumes.csv")
